...
alias checkExist='source ~/UserScripts/vite/checkExist.zsh'                 # 用來確認指定檔案是存在.js 或 .ts
alias insertMain='source ~/UserScripts/vite/insertMain.zsh'
alias     valias='source ~/UserScripts/vite/viteAlias.zsh'
...
alias      vtail='source ~/UserScripts/vite/vtailwind.zsh'
alias      vtail='source ~/UserScripts/vite/vtailwind.zsh'
